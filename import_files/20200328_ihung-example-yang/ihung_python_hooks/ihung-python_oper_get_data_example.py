...
try:
    ...
    #try:
    subscribe.oper_get_items_subscribe(module_name, "/ietf-interfaces:interfaces-state", oper_get_items_cb3)
    #subscribe.oper_get_items_subscribe(module_name, "/ietf-interfaces:interfaces", oper_get_items_cb3)
    #except Exception as e:
    #    print(e)
