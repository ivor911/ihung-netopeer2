...
ctx = None
try:
    ctx = ly.Context("/netconf-yang/yang")
    ...
    node = None
    try:
        if node is None : node = ctx.parse_data_path("/netconf-yang/data/turing-machine.startup", ly.LYD_LYB, ly.LYD_OPT_CONFIG)
    except Exception as e:
        print(e)
    try:
        if node is None : node = ctx.parse_data_path("/netconf-yang/data/turing-machine.startup", ly.LYD_XML, ly.LYD_OPT_CONFIG)
    except Exception as e:
        print(e)
    try:
        if node is None : node = ctx.parse_data_path("/netconf-yang/data/turing-machine.startup", ly.LYD_JSON, ly.LYD_OPT_CONFIG)
    except Exception as e:
        print(e)
